...
quasarnoded tendermint unsafe-reset-all --keep-addr-book --home $HOME/.quasarnode
```

### Get and configure the state sync information

```bash
STATE_SYNC_RPC=https://quasar.rpc.kjnodes.com:443
STATE_SYNC_PEER=d9bfa29e0cf9c4ce0cc9c26d98e5d97228f93b0b@quasar.rpc.kjnodes.com:14856
...
```bash
curl -L https://snapshots.kjnodes.com/quasar/wasm_latest.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.quasarnode
```
