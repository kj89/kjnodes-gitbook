...
```bash
STATE_SYNC_RPC=https://nois.rpc.kjnodes.com:443
STATE_SYNC_PEER=d9bfa29e0cf9c4ce0cc9c26d98e5d97228f93b0b@nois.rpc.kjnodes.com:151656
...
```bash
curl -L https://snapshots.kjnodes.com/nois/wasm_latest.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.noisd
```
