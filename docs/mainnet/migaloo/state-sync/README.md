...
```bash
STATE_SYNC_RPC=https://migaloo.rpc.kjnodes.com:443
STATE_SYNC_PEER=d9bfa29e0cf9c4ce0cc9c26d98e5d97228f93b0b@migaloo.rpc.kjnodes.com:149656
...
```bash
curl -L https://snapshots.kjnodes.com/migaloo/wasm_latest.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.migalood
```
