...
Snapshots are taken automatically each day at **7:30 UTC**

**pruning**: 100/0/19 | **indexer**: null | **version tag**: v7-Theta

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 13201941 | 23 hours ago | [snapshot (15.11 GB)](https://snapshots.kjnodes.com/cosmoshub/snapshot\_latest.tar.lz4) |
