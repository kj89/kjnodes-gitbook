...
Snapshots are taken automatically each day at **1:30 UTC**

**pruning**: 100/0/19 | **indexer**: null | **version tag**: v0.7.1

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 6080202 | 5 hours ago | [snapshot (1.93 GB)](https://snapshots.kjnodes.com/kujira/snapshot\_latest.tar.lz4) |
