...
**pruning**: _100/0/19_ | **indexer**: _null_ | **version tag**: _v0.6.4_

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 4977784 | 22 hours ago | [snapshot (1.54 GB)](https://snapshots.kjnodes.com/kujira/snapshot\_latest.tar.lz4) |
