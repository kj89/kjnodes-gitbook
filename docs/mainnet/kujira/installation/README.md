...
kujirad config node tcp://localhost:113657
...
# Add seeds
sed -i -e "s|^seeds *=.*|seeds = \"400f3d9e30b69e78a7fb891f60d76fa3c73f0ecc@kujira.rpc.kjnodes.com:113659\"|" $HOME/.kujira/config/config.toml
...
# Set custom ports
sed -i -e "s%^proxy_app = \"tcp://127.0.0.1:26658\"%proxy_app = \"tcp://127.0.0.1:113658\"%; s%^laddr = \"tcp://127.0.0.1:26657\"%laddr = \"tcp://127.0.0.1:113657\"%; s%^pprof_laddr = \"localhost:6060\"%pprof_laddr = \"localhost:113060\"%; s%^laddr = \"tcp://0.0.0.0:26656\"%laddr = \"tcp://0.0.0.0:113656\"%; s%^prometheus_listen_addr = \":26660\"%prometheus_listen_addr = \":113660\"%" $HOME/.kujira/config/config.toml
sed -i -e "s%^address = \"tcp://0.0.0.0:1317\"%address = \"tcp://0.0.0.0:113317\"%; s%^address = \":8080\"%address = \":113080\"%; s%^address = \"0.0.0.0:9090\"%address = \"0.0.0.0:113090\"%; s%^address = \"0.0.0.0:9091\"%address = \"0.0.0.0:113091\"%; s%:8545%:113545%; s%:8546%:113546%; s%:6065%:113065%" $HOME/.kujira/config/app.toml
```
