...
STATE_SYNC_PEER=d9bfa29e0cf9c4ce0cc9c26d98e5d97228f93b0b@kujira.rpc.kjnodes.com:113656
...
```bash
curl -L https://snapshots.kjnodes.com/kujira/wasm_latest.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.kujira
```
