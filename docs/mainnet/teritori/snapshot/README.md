...
**pruning**: _100/0/19_ | **indexer**: _null_ | **version tag**: _v1.3.0_

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 549107 | 23 hours ago | [snapshot (5.23 GB)](https://snapshots.kjnodes.com/teritori/snapshot\_latest.tar.lz4) |
