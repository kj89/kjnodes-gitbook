...
**pruning**: 100/0/19 | **indexer**: null | **version tag**: euphoria_v0.4.1

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 2000025 | 39 seconds ago | [snapshot (0.56 GB)](https://snapshots.kjnodes.com/aura-testnet/snapshot\_latest.tar.lz4) |
