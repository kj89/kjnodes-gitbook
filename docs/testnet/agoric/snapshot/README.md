...
**pruning**: 100/0/19 | **indexer**: null | **version tag**: mainnet1B-rc0

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 21874 | 4 hours | [snapshot (0.27 GB)](https://snapshots.kjnodes.com/agoric-testnet/snapshot\_latest.tar.lz4) |
