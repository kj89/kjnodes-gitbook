...
**pruning**: 100/0/19 | **indexer**: null | **version tag**: mainnet1B-rc3

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 74808 | 3 hours | [snapshot (0.28 GB)](https://snapshots.kjnodes.com/agoric-testnet/snapshot\_latest.tar.lz4) |
