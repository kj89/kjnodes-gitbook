...
Snapshots are taken automatically each day at **4:30 UTC**

**pruning**: 100/0/19 | **indexer**: null | **version tag**: agorictest-upgrade-8

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 1869293 | 2 hours ago | [snapshot (5.95 GB)](https://snapshots.kjnodes.com/agoric-testnet/snapshot\_latest.tar.lz4) |
