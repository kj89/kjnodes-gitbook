...
agd tendermint unsafe-reset-all --keep-addr-book --home $HOME/.agoric
```

### Get and configure the state sync information

```bash
STATE_SYNC_RPC=https://agoric-testnet.rpc.kjnodes.com:443
STATE_SYNC_PEER=d5519e378247dfb61dfe90652d1fe3e2b3005a5b@agoric-testnet.rpc.kjnodes.com:12756
