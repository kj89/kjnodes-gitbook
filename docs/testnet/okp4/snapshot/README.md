...
Snapshots are taken automatically each day at **09:30 UTC**

**pruning**: 100/0/19 | **indexer**: null | **version tag**: v3.0.0

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 129197 | 49 minutes ago | [snapshot (0.57 GB)](https://snapshots.kjnodes.com/okp4-testnet/snapshot\_latest.tar.lz4) |
