...
**pruning**: 100/0/19 | **indexer**: null | **version tag**: wakeandbake

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 1904270 | 17 minutes | [snapshot (0.31 GB)](https://snapshots.kjnodes.com/bitcanna-testnet/snapshot\_latest.tar.lz4) |
