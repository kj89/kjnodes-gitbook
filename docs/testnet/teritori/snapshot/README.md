...
Snapshots are taken automatically each day at **0:30 UTC**

**pruning**: 100/0/19 | **indexer**: null | **version tag**: v1.3.0

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 2324387 | 6 hours ago | [snapshot (0.85 GB)](https://snapshots.kjnodes.com/teritori-testnet/snapshot\_latest.tar.lz4) |
