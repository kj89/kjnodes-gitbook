...
Snapshots are taken automatically each day at **8:30 UTC**

**pruning**: 100/0/19 | **indexer**: null | **version tag**: v1.2.1

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 1347122 | 22 hours ago | [snapshot (3.21 GB)](https://snapshots.kjnodes.com/haqq-testnet/snapshot\_latest.tar.lz4) |
