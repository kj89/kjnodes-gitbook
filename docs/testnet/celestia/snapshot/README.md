...
**pruning**: 100/0/19 | **indexer**: null | **version tag**: v0.12.0

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 14382 | 24 minutes | [snapshot (2.42 GB)](https://snapshots.kjnodes.com/celestia-testnet/snapshot\_latest.tar.lz4) |
