...
**pruning**: _100/0/19_ | **indexer**: _null_ | **version tag**: _v0.15.0_

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 322522 | 20 hours ago | [snapshot (1.26 GB)](https://snapshots.kjnodes.com/nibiru-testnet/snapshot\_latest.tar.lz4) |
