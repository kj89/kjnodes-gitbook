...
Snapshots are taken automatically each day at **3:30 UTC**

**pruning**: 100/0/19 | **indexer**: null | **version tag**: v0.15.0

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 1001436 | 3 hours ago | [snapshot (2.56 GB)](https://snapshots.kjnodes.com/nibiru-testnet/snapshot\_latest.tar.lz4) |
