...
Snapshots are taken automatically each day at **11:00 UTC**

**pruning**: 100/0/19 | **indexer**: null | **version tag**: v015

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 1186302 | 27 minutes ago | [snapshot (0.19 GB)](https://snapshots.kjnodes.com/hypersign-testnet/snapshot\_latest.tar.lz4) |
