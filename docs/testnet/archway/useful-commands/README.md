...
```bash
archwayd tx slashing unjail --from wallet --chain-id constantine-2 --gas-adjustment 1.4 --gas auto --gas-prices 0uconst -y
```
...
```bash
archwayd tx distribution withdraw-all-rewards --from wallet --chain-id constantine-2 --gas-adjustment 1.4 --gas auto --gas-prices 0uconst -y
```

#### Withdraw commission and rewards from your validator

```bash
archwayd tx distribution withdraw-rewards $(archwayd keys show wallet --bech val -a) --commission --from wallet --chain-id constantine-2 --gas-adjustment 1.4 --gas auto --gas-prices 0uconst -y
```

#### Delegate tokens to yourself

```bash
archwayd tx staking delegate $(archwayd keys show wallet --bech val -a) 1000000uconst --from wallet --chain-id constantine-2 --gas-adjustment 1.4 --gas auto --gas-prices 0uconst -y
```

#### Delegate tokens to validator

```bash
archwayd tx staking delegate <TO_VALOPER_ADDRESS> 1000000uconst --from wallet --chain-id constantine-2 --gas-adjustment 1.4 --gas auto --gas-prices 0uconst -y
```

#### Redelegate tokens to another validator

```bash
archwayd tx staking redelegate $(archwayd keys show wallet --bech val -a) <TO_VALOPER_ADDRESS> 1000000uconst --from wallet --chain-id constantine-2 --gas-adjustment 1.4 --gas auto --gas-prices 0uconst -y
```

#### Unbond tokens from your validator

```bash
archwayd tx staking unbond $(archwayd keys show wallet --bech val -a) 1000000uconst --from wallet --chain-id constantine-2 --gas-adjustment 1.4 --gas auto --gas-prices 0uconst -y
```

#### Send tokens to the wallet

```bash
archwayd tx bank send wallet <TO_WALLET_ADDRESS> 1000000uconst --from wallet --chain-id constantine-2 --gas-adjustment 1.4 --gas auto --gas-prices 0uconst -y
```
...
```bash
archwayd tx gov vote 1 yes --from wallet --chain-id constantine-2 --gas-adjustment 1.4 --gas auto --gas-prices 0uconst -y
```

#### Vote 'No'

```bash
archwayd tx gov vote 1 no --from wallet --chain-id constantine-2 --gas-adjustment 1.4 --gas auto --gas-prices 0uconst -y
```

#### Vote 'Abstain'

```bash
archwayd tx gov vote 1 abstain --from wallet --chain-id constantine-2 --gas-adjustment 1.4 --gas auto --gas-prices 0uconst -y
```

#### Vote 'NoWithVeto'

```bash
archwayd tx gov vote 1 NoWithVeto --from wallet --chain-id constantine-2 --gas-adjustment 1.4 --gas auto --gas-prices 0uconst -y
```
