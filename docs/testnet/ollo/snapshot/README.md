...
**pruning**: _100/0/19_ | **indexer**: _null_ | **version tag**: _v0.0.1_

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 128957 | 18 hours ago | [snapshot (0.8 GB)](https://snapshots.kjnodes.com/ollo-testnet/snapshot\_latest.tar.lz4) |
