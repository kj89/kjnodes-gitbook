...
**pruning**: 100/0/19 | **indexer**: null | **version tag**: async

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 1055428 | 14 minutes | [snapshot (0.59 GB)](https://snapshots.kjnodes.com/jackal-testnet/snapshot\_latest.tar.lz4) |
