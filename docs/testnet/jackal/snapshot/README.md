...
**pruning**: 100/0/19 | **indexer**: null | **version tag**: params

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 1148985 | 37 minutes | [snapshot (0.56 GB)](https://snapshots.kjnodes.com/jackal-testnet/snapshot\_latest.tar.lz4) |
