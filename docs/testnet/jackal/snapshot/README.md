...
**pruning**: 100/0/19 | **indexer**: null | **version tag**: alpha11

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 616080 | 32 seconds | [snapshot (0.36 GB)](https://snapshots.kjnodes.com/jackal-testnet/snapshot\_latest.tar.lz4) |
