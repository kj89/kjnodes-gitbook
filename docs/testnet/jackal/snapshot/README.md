...
**pruning**: 100/0/19 | **indexer**: null | **version tag**: beta7

| BLOCK             | AGE             | DOWNLOAD                                                                                            |
| ----------------- | --------------- | --------------------------------------------------------------------------------------------------- |
| 1550767 | 59 minutes | [snapshot (2.06 GB)](https://snapshots.kjnodes.com/jackal-testnet/snapshot\_latest.tar.lz4) |
