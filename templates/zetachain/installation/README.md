...
wget -O $HOME/${CHAIN_DIR}/cosmovisor/genesis/bin/zetacored https://zetachain-external-files.s3.amazonaws.com/binaries/athens3/latest/zetacored-ubuntu-22-amd64
chmod +x $HOME/${CHAIN_DIR}/cosmovisor/genesis/bin/zetacored
